...
const YatrAmore = {
    ...
    renderNav(activePage) {
        ...
        const isCollaboratorPage = activePage === 'collaborator';
        const luckyDrawHref = isCollaboratorPage ? '#lucky-draw' : '/collaborator#lucky-draw';
